...
public class BonitaService {
    ...
    public Serializable getCaseVariable(long processInstanceId, String name)
        throws BonitaHomeNotSetException, ServerAPIException, UnknownAPITypeException, DataNotFoundException,
        BusinessObjectDaoCreationException, ContractDataNotFoundException {
        return 88L;
    }
